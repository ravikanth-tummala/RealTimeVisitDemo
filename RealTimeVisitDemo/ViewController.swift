...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if UserDefaults.standard.bool(forKey: starTracking){
            UserLocationManger.shared.startUpdateLocationManager(pauseLocationValue, clVisitValue)
    ...
    @IBAction func startTracking(_ sender: Any) {
        ...
        UserLocationManger.shared.startUpdateLocationManager(pauseLocationSwitch.isOn, clvisitSwitch.isOn)
